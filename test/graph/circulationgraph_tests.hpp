...
10
    ...
    EXPECT_EQ(adjacency_list[0][0].capacity, 7);
    EXPECT_EQ(adjacency_list[0][1].node, 3);
    EXPECT_EQ(adjacency_list[0][1].capacity, 8);

    EXPECT_EQ(adjacency_list[1].size(), 0);

    EXPECT_EQ(adjacency_list[2][0].node, 3);
    EXPECT_EQ(adjacency_list[2][0].capacity, 10);
    EXPECT_EQ(adjacency_list[2][1].node, 4);
    EXPECT_EQ(adjacency_list[2][1].capacity, 3);

    EXPECT_EQ(adjacency_list[3][0].node, 4);
    EXPECT_EQ(adjacency_list[3][0].capacity, 6);

    EXPECT_EQ(adjacency_list[4][0].node, 1);
    EXPECT_EQ(adjacency_list[4][0].capacity, 10);
